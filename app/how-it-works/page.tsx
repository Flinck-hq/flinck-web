    ...
    <PageShell>
      <section className="px-4 py-12 sm:px-6 lg:px-8 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-[1fr_0.9fr] lg:items-center">
            <div className="max-w-3xl">
              ...
              <Button
                asChild
                size="lg"
                className="mt-8 h-14 rounded-full bg-[#163d2a] px-8 text-white"
              >
            ...
            <div className="relative aspect-video overflow-hidden rounded-[2.5rem] border border-slate-900/10 shadow-xl">
              <Image
          ...
          <div className="relative mt-20 aspect-video w-full overflow-hidden rounded-[3rem] border border-slate-900/10 bg-white shadow-xl">
            <Image
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2">
            {flows.map((flow, index) => (
              <div
                key={flow}
                className="rounded-[2rem] border border-slate-900/8 bg-white/90 p-8"
              >
