...
export const metadata: Metadata = {
  title: "Sponsors",
  description:
    "Sponsor Flinck and support the growth of smallholder farmers. We work with banks, governments, agribusinesses, and investors to build trusted market infrastructure for agriculture.",
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              We work with institutions that need trusted market
              infrastructure—not another disconnected pilot. Tell us your
              geography, compliance needs, and integration goals.
            </p>
          </div>
          ...
          <div className="mt-16 rounded-[3rem] bg-[#163d2a] px-8 py-12 text-white sm:px-12">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              ...
              >
                <a
                  href={`mailto:${PARTNER_EMAIL}?subject=Flinck%20Partnership`}
                >
                  Sponsor Flinck
                </a>
              </Button>
          ...
          <p className="mt-10 text-center text-sm text-slate-600">
            ...
            <Link
              href="/download"
              className="font-medium text-[#163d2a] underline"
            >
              download the app
            </Link>{" "}
            or read our{" "}
